...
public sealed class ShiftWindowTests
{
    ...
    [Fact]
    public async Task Reports_load_exactly_their_window_and_humanize_the_subject()
    {
        // AfternoonReport_UsesHalfOpenBoundaries_And_NightReport_IncludesTheSmallHoursOfTheFollowingDay
        {
        ...
        // FullDayReport_ExcludesAdjacentDays_And_Report_HumanizesThePrimarySubject
        {
