...
{
    [Fact]
    public void TryExtract_ReturnsTrue_WhenPayloadIsWellFormed_And_TryExtract_ReturnsFalse_WhenPayloadIsMalformed()
    {
        // TryExtract_ReturnsTrue_WhenPayloadIsWellFormed
        {
        ...
        // TryExtract_ReturnsFalse_WhenPayloadIsMalformed
        {
    ...
    [Fact]
    public void TryExtract_ReturnsFalse_WhenPayloadContainsNestedStartTag_And_TryExtract_ReturnsTrue_WhenPayloadHasAIPreamble()
    {
        // TryExtract_ReturnsFalse_WhenPayloadContainsNestedStartTag
        {
        ...
        // TryExtract_ReturnsTrue_WhenPayloadHasAIPreamble
        {
