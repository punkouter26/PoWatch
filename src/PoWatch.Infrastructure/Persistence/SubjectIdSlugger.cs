...
/// <para>
/// Lives in Infrastructure, not Domain: the slug registry is mutable PROCESS state that only
/// makes sense next to the storage implementations that enforce unique subject keys. Domain
/// stays pure (no static mutable registries).
/// </para>
/// </summary>
